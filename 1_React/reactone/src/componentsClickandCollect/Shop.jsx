      ...
      <div className=" grid grid-cols-1 lg:grid-cols-2 gap-2">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-1">{
          products.map(product =>{
            return <Products key={product._id} name={product.name} img={product.img} rating={product.rating} price={product.price} category={product.category} addTocart={cartAdd} _id={product._id}/>
          })
        }</div>
        <Details cart={cart} />
      </div>
